...
### peer-to-peer
- toward to high availability and eventual consistency
- gossip protocol is peer-to-peer state management

# message broadcast in distributed system
### point-to-point
- producers send message directly to consumers
...
- is robust, scalable and eventual consistent algorithm -> maintain node membership list, consensus, and fault detection
